...
// --- MYABILITY ---
export const myability = makeLangText("C, C++98, Python, Ada, x86_64 ASM · C3, Zig, Rust, Go · Linux/POSIX, ELF/Multiboot2 · Système bas niveau, Noyau OS, Machines virtuelles · Réseaux, WebSocket, HTTP/REST · Analyse binaire, Cybersécurité · LaTeX, Markdown, Doxygen · Anglais C1", "C, C++98, Python, Ada, x86_64 ASM · C3, Zig, Rust, Go · Linux/POSIX, ELF/Multiboot2 · Low-level Systems, OS Kernel, Virtual Machines · Networking, WebSocket, HTTP/REST · Binary Analysis, Cybersecurity · LaTeX, Markdown, Doxygen · English C1");
// --- MYFUTURE ---
...
export const address = makeLangText("Parthenay, France");
...
export const backBtn = makeLangText("Retour aux projets", "Back to projects");
export const contactSub = makeLangText("Étudiant passionné, ouvert à tout échange autour de l'informatique fondamentale.", "Passionate student, open to any exchange around fundamental computer science.");
export const projectsSub = makeLangText("Chaque projet est une occasion d'explorer les couches basses: du silicium à l'algorithme.", "Each project is an opportunity to explore the lower layers: from silicon to algorithm.");
